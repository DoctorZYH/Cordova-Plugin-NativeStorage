...
import com.kaolabanban.home.MyApp;
...
/**
 * Created by Genda on 2020/10/10.
 */
public final class SPUtils {
    ...
    private SPUtils(final String spName) {
        sp = MyApp.get().getSharedPreferences(spName, Context.MODE_PRIVATE);
    }
